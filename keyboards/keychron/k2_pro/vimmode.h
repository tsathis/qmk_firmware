...
#define L_SHIFT_HELD (get_mods() & (MOD_BIT(KC_LEFT_SHIFT)))
#define R_SHIFT_HELD (get_mods() & (MOD_BIT(KC_RIGHT_SHIFT)))
#define SHIFT_HELD (L_SHIFT_HELD || R_SHIFT_HELD)
#define L_CTRL_HELD (get_mods() & (MOD_BIT(KC_LEFT_CTRL)))
#define R_CTRL_HELD (get_mods() & (MOD_BIT(KC_RIGHT_CTRL)))
#define CTRL_HELD (L_CTRL_HELD || R_CTRL_HELD)
#define L_GUI_HELD (get_mods() & (MOD_BIT(KC_LEFT_GUI)))
#define R_GUI_HELD (get_mods() & (MOD_BIT(KC_RIGHT_GUI)))
#define GUI_HELD (L_GUI_HELD || R_GUI_HELD)

// uncomment if not defined elsewhere
...
#define HOLD_SHIFT register_mods(MOD_BIT(KC_LEFT_SHIFT))
#define UNHOLD_SHIFT unregister_mods(MOD_BIT(KC_LEFT_SHIFT))
#define HOLD_ALT register_mods(MOD_BIT(KC_LEFT_ALT))
#define UNHOLD_ALT unregister_mods(MOD_BIT(KC_LEFT_ALT))
#define HOLD_GUI register_mods(MOD_BIT(KC_LEFT_GUI))
#define UNHOLD_GUI unregister_mods(MOD_BIT(KC_LEFT_GUI))
#define HOLD_CTRL register_mods(MOD_BIT(KC_LEFT_CTRL))
#define UNHOLD_CTRL unregister_mods(MOD_BIT(KC_LEFT_CTRL))
#define ALT KC_LEFT_ALT
#define GUI KC_LEFT_GUI
#define SHIFT KC_LEFT_SHIFT
...
void handle_vim_cmd(void) {
  ...
  if (rshift) unregister_mods(MOD_BIT(KC_RIGHT_SHIFT));

  if (handle_cmd(last_char, prev_char, prev_num))
    currcmdsize = 0;

  if (lshift) HOLD_SHIFT;
  if (rshift) register_mods(MOD_BIT(KC_RIGHT_SHIFT));
}
